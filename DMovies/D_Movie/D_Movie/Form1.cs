...
namespace D_Movie       // 178002002    DIEUVEILLE  BOUSSA ELLENGA 
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            string connectionString = "Provider=Microsoft.ace.oledb.12.0;Data Source=D_DataBase.accdb";
            ...
            try
            {
                ...
                string queryString = "SELECT movieID, Title, Publisher, Previewed, MovieYear, Type FROM movie, videoType WHERE videoType.typeID = movie.typeID";
        ...
        {
            Process.Start("https://www.the-whiner.com");
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (yr != 1)
            {
                ...
                if (response >= 1) MessageBox.Show("Movie was added to database", "Successful", MessageBoxButtons.OK, MessageBoxIcon.Information);
                textBox1.Clear();
                textBox2.Clear();
                textBox3.Clear();
                comboBox1.ResetText();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (title != "")
            {
                string queryString = "SELECT movieID, Title, Publisher, Previewed, MovieYear, Type FROM movie, videoType WHERE videoType.typeID = movie.typeID AND movie.title LIKE '" + title + "%'";
                loadDataGrid(queryString);
            }
            else
            {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (typeString == "Biography") type = 14;
            if (typeString == "Romantic") type = 15;
            string queryString = "SELECT movieID, Title, Publisher, Previewed, MovieYear, Type FROM movie, videoType WHERE videoType.typeID = movie.typeID AND movie.typeID = " + type + "";
            loadDataGrid(queryString);
        }
        #endregion
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                string queryString = "SELECT movieID, Title, Publisher, Previewed, MovieYear, Type FROM movie, videoType WHERE videoType.typeID = movie.typeID AND movie.MovieYear BETWEEN " + yr1 + " AND " + yr2 + "";
                loadDataGrid(queryString);
            }
            else
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string queryString = "SELECT movieID, Title, Publisher, Previewed, MovieYear, Type FROM movie, videoType WHERE videoType.typeID = movie.typeID AND Previewed ='" + previewed + "'";
            loadDataGrid(queryString);
        }
        #endregion
